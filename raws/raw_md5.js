(function dartProgram(){function copyProperties(a,b){var s=Object.keys(a)
    ...
    lazy_old($,"yi","d3",function(){return "exchange"})
    lazy_old($,"ym","eZ",function(){return "half"})
    lazy_old($,"y7","a7",function(){return "charge"})
    lazy_old($,"yk","eY",function(){return "fire"})
    lazy_old($,"yr","bS",function(){return "ice"})
    lazy_old($,"y_","lN",function(){return "accumulate"})
    lazy_old($,"yK","bT",function(){return "piston"})
    ...
    lazy_old($,"yc","iJ",function(){return "corpose"})
    lazy_old($,"zg","lR",function(){return "shield"})
    lazy_old($,"yL","d6",function(){return "protect"})
    lazy_old($,"zo","nl",function(){return "upgrade"})
    lazy_old($,"yf","lP",function(){return "disperse"})
    lazy_old($,"zA","qZ",function(){return "zombie"})
    lazy_old($,"ze","qM",function(){return "shadow"})
    lazy_old($,"zl","qQ",function(){return "summon"})
    lazy_old($,"yE","na",function(){return "minionCount"})
    lazy_old($,"y6","n4",function(){return O.j("1m3tkgG&,{P",97)})
    lazy_old($,"yB","lQ",function(){return "mario"})
