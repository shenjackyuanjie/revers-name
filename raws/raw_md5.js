(function dartProgram(){function copyProperties(a,b){var s=Object.keys(a)
    ...
    lazy_old($,"zk","qP",function(){return "sonic"})
    lazy_old($,"yF","qo",function(){return "mosquito"})
    lazy_old($,"zz","qY",function(){return "yuri"})
    lazy_old($,"zi","qO",function(){return "slime"})
    lazy_old($,"ys","qh",function(){return "ikaruga"})
    lazy_old($,"yb","qb",function(){return "conan"})
